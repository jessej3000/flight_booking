...
var _Plane = __webpack_require__(34);

var _Plane2 = _interopRequireDefault(_Plane);

var _BookingSection = __webpack_require__(40);

var _BookingSection2 = _interopRequireDefault(_BookingSection);
...
var App = function (_Component) {
	...
	_createClass(App, [{
   	...
   	console.log(":::: " + names)*/
		...
		key: 'selectSeat',
		value: function selectSeat(index) {
			var _state2 = this.state,
			    CLIENTID = _state2.CLIENTID,
			    CLIENTNAME = _state2.CLIENTNAME,
			    seats = _state2.seats,
			    selected = _state2.selected,
			    names = _state2.names,
			    FLIGHTID = _state2.FLIGHTID;
		...
		value: function assignSeat() {
			var _state3 = this.state,
			    rowsCount = _state3.rowsCount,
			    seatsInRow = _state3.seatsInRow,
			    selected = _state3.selected,
			    seats = _state3.seats,
			    CLIENTID = _state3.CLIENTID,
			    CLIENTNAME = _state3.CLIENTNAME,
			    names = _state3.names,
		...
		key: 'getAllSeatNumbers',
		value: function getAllSeatNumbers() {
			var _state4 = this.state,
			    seatsInRow = _state4.seatsInRow,
			    rowsCount = _state4.rowsCount,
			    abc = _state4.abc,
			    names = _state4.names;
		...
		value: function render() {
			var _state5 = this.state,
			    seatsInRow = _state5.seatsInRow,
			    rowsCount = _state5.rowsCount,
			    names = _state5.names;
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						'div',
						{ className: 'col s8' },
						_react2.default.createElement(_Plane2.default, _extends({}, this.state, {
							booked: booked,
					...
					_react2.default.createElement(
						'div',
						{ className: 'col s4' },
						_react2.default.createElement(_BookingSection2.default, {
...
var _Cabin = __webpack_require__(35);
	...
	_createClass(Plane, [{
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement('div', { className: 'exit exit--front fuselage' }),
				_react2.default.createElement(_Cabin2.default, _extends({}, this.props, {
...
Plane.propsType = {
	seatsInRow: _propTypes2.default.array.isRequired,
	rowsCount: _propTypes2.default.array.isRequired,
	abc: _propTypes2.default.array.isRequired,
	booked: _propTypes2.default.array.isRequired,
	selectSeat: _propTypes2.default.func.isRequired
};
...
var Cabin = function (_Component) {
	_inherits(Cabin, _Component);

	function Cabin() {
		_classCallCheck(this, Cabin);

		return _possibleConstructorReturn(this, (Cabin.__proto__ || Object.getPrototypeOf(Cabin)).apply(this, arguments));
	}
	...
	_createClass(Cabin, [{
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				this.props.rowsCount.map(function (row) {
					rowsCounter++;
					return _react2.default.createElement(_Row2.default, _extends({}, _this2.props, {
						key: rowsCounter,
						seats: _this2.props.seatsInRow,
...
var _Seat = __webpack_require__(37);
	...
	_createClass(Row, [{
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'ol',
					{ className: 'seats', type: 'A' },
					this.props.seats.map(function (upuan) {
						var seatNumberLabel = _this2.props.rowNumber + "" + _this2.props.abc[seatsCounter];

						var base = (_this2.props.rowNumber - 1) * seatLength;

						seatsCounter++;
						var seatIndexCounter = base + seatsCounter;
						return _react2.default.createElement(_Seat2.default, _extends({}, _this2.props, {
							key: seatsCounter,
							seatNumber: seatNumberLabel,
							seats: _this2.props.seats,
							seatIndex: seatIndexCounter,
							selectSeat: _this2.props.selectSeat
...
Row.propTypes = {
	seats: _propTypes2.default.array.isRequired,
	...
	_createClass(Seat, [{
		...
		value: function onClick(e) {
			...
			var _props = this.props,
			    seatIndex = _props.seatIndex,
			    selectSeat = _props.selectSeat;
		...
		value: function render() {
			...
			return _react2.default.createElement(
				'li',
				{ className: 'seat', style: seatsStyle },
				_react2.default.createElement('input', { type: 'checkbox', id: rowNum, disabled: disabled, onClick: this.onClick.bind(this) }),
				_react2.default.createElement(
					'label',
					{ htmlFor: rowNum },
					rowNum
...
Seat.propsType = {
	seatNumber: _propTypes2.default.number.isRequired,
	seats: _propTypes2.default.array.isRequired,
	seatIndex: _propTypes2.default.number.isRequired,
	booked: _propTypes2.default.array.isRequired
};
...
var _BookingForm = __webpack_require__(41);

var _BookingForm2 = _interopRequireDefault(_BookingForm);

var _BookingList = __webpack_require__(42);
...
var BookingSection = function (_Component) {
	_inherits(BookingSection, _Component);

	function BookingSection() {
		_classCallCheck(this, BookingSection);

		return _possibleConstructorReturn(this, (BookingSection.__proto__ || Object.getPrototypeOf(BookingSection)).apply(this, arguments));
	}

	_createClass(BookingSection, [{
		key: 'render',
		value: function render() {
			return _react2.default.createElement(
				'div',
				{ className: 'support panel panel-primary half-screen-height' },
				_react2.default.createElement(
					'h5',
					{ className: 'header' },
					_react2.default.createElement(
				...
				_react2.default.createElement(
					'div',
					null,
					_react2.default.createElement(_BookingForm2.default, this.props)
				),
				_react2.default.createElement(
					'div',
					{ className: 'panel-body channels panel1-body' },
					_react2.default.createElement(_BookingList2.default, this.props)
				)
			);
		}
	}]);
...
BookingSection.propTypes = {
	bookings: _propTypes2.default.array.isRequired,
	setBooking: _propTypes2.default.func.isRequired,
	addBooking: _propTypes2.default.func.isRequired,
	deleteBooking: _propTypes2.default.func.isRequired,
	seats: _propTypes2.default.number.isRequired,
	rows: _propTypes2.default.number.isRequired,
	assignSeat: _propTypes2.default.func.isRequired
};

exports.default = BookingSection;
...
var BookingForm = function (_Component) {
	...
	_createClass(BookingForm, [{
		...
		value: function onClick(e) {
			e.preventDefault();
			var assignSeat = this.props.assignSeat;
		...
		value: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						'button',
						{ className: 'btn waves-effect waves-light', onClick: this.onClick.bind(this), type: 'submit', name: 'action' },
						'Book Me Now!',
						_react2.default.createElement(
							'i',
...
var _Booking = __webpack_require__(43);
...
var BookingList = function (_Component) {
	...
	function BookingList(props) {
		...
		var _this = _possibleConstructorReturn(this, (BookingList.__proto__ || Object.getPrototypeOf(BookingList)).call(this, props));
	...
	_createClass(BookingList, [{
		key: 'changeHandler',
		value: function changeHandler(index) {
     ...
     if (chan.ID == this.state.activeIndex) {
     	cName = "collection-item waves-effect waves-light active";
					...
					return _react2.default.createElement(_Booking2.default, {
						key: booking.Index,
						booking: booking,
						setBooking: _this2.props.setBooking,
						deleteBooking: _this2.props.deleteBooking,
						changeHandler: _this2.changeHandler.bind(_this2),
						seats: _this2.props.seats,
...
var Channel = function (_Component) {
   ...
   setChannel(booking);*/
		...
		key: 'onClickX',
		value: function onClickX(e) {
			e.preventDefault();
			var _props = this.props,
			    deleteBooking = _props.deleteBooking,
			    booking = _props.booking;
		...
		value: function onSelectItem(e) {
			...
			var _props2 = this.props,
			    ...
			    booking = _props2.booking;

			changeHandler(booking.ID);
		}
	}, {
		key: 'getSeatNumber',
		value: function getSeatNumber(index) {
		...
		value: function render() {
			...
			return _react2.default.createElement(
				'a',
				{ className: 'collection-item waves-effect waves-light', onMouseDown: this.onSelectItem.bind(this) },
				seatNumber,
				' : ',
				booking.Name,
				_react2.default.createElement(
					...
					_react2.default.createElement(
						'i',
						{ onClick: this.onClickX.bind(this), className: 'material-icons' },
						'delete'
					)
				)
			);
...
Channel.propTypes = {
	booking: _propTypes2.default.object.isRequired,
	setBooking: _propTypes2.default.func.isRequired,
	deleteBooking: _propTypes2.default.func.isRequired,
