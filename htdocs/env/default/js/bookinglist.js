...
var _BookingListSection = __webpack_require__(34);

var _BookingListSection2 = _interopRequireDefault(_BookingListSection);
...
var App = function (_Component) {
	...
	_createClass(App, [{
		key: 'filterBookings',
		value: function filterBookings(query) {}
	}, {
		key: 'updateFlightList',
		value: function updateFlightList(flightID) {
			var _state = this.state,
			    FlightName = _state.FlightName,
			    Origin = _state.Origin,
			    Destination = _state.Destination,
			    Departure = _state.Departure,
			    Arrival = _state.Arrival,
			    bookings = _state.bookings,
			    bookingsDummy = _state.bookingsDummy;
			...
			_axios2.default.post('http://localhost:8282/getbookingslist/', bodyFormData).then(function (response) {
				...
				self.setState({ FlightName: FlightName });
				self.setState({ Origin: Origin });
				self.setState({ Destination: Destination });
				self.setState({ Departure: Departure });
				self.setState({ Arrival: Arrival });

				bookingsDummy = bookings;
				self.setState({ bookingsDummy: bookingsDummy });
				self.setState({ bookings: bookings });
			});
		}
	}, {
		key: 'fixBookings',
		value: function fixBookings(bookedPassengers, seatIndexes, divider, seatOrder) {
			var tmpNames = [];
		...
		key: 'getRow',
		value: function getRow(number, divider) {
		...
		key: 'getCol',
		value: function getCol(number, divider) {
			if (number <= divider) {
				return number - 1;
			}
			var remainder = number % divider;
		...
		value: function searchQuery(query) {
			var _state2 = this.state,
			    bookings = _state2.bookings,
			    bookingsDummy = _state2.bookingsDummy;
			...
			if (query.trim().length > 0) {
				newArray = bookingsDummy.filter(function (el) {
					return el.Name.indexOf(query) > -1 || el.ID.toString().indexOf(query) > -1 || el.SeatNumber.indexOf(query) > -1 || el.Index.toString().indexOf(query) > -1 || el.BookingOrder.toString().indexOf(query) > -1;
				});
			} else {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						'div',
						{ className: 'col s12' },
						_react2.default.createElement(_BookingListSection2.default, _extends({}, this.state, {
...
var _BookingListForm = __webpack_require__(39);

var _BookingListForm2 = _interopRequireDefault(_BookingListForm);
...
var BookingListSection = function (_Component) {
	_inherits(BookingListSection, _Component);

	function BookingListSection() {
		_classCallCheck(this, BookingListSection);

		return _possibleConstructorReturn(this, (BookingListSection.__proto__ || Object.getPrototypeOf(BookingListSection)).apply(this, arguments));
	}

	_createClass(BookingListSection, [{
		key: 'render',
		value: function render() {
			return _react2.default.createElement(
				'div',
				...
				_react2.default.createElement(
					...
					_react2.default.createElement('img', { src: '/images/plane1.jpg' }),
					_react2.default.createElement(
						'span',
						{ className: 'card-title', style: { top: 0 } },
						'Actelligent Booking List'
					)
				),
				_react2.default.createElement(
					'div',
					...
					_react2.default.createElement(
						'div',
						null,
						_react2.default.createElement(_BookingListForm2.default, this.props)
					),
					_react2.default.createElement(
						'div',
						null,
	...
	return BookingListSection;
}(_react.Component);

BookingListSection.propTypes = {
	bookings: _propTypes2.default.array.isRequired,
	flights: _propTypes2.default.array.isRequired,
	updateFlightList: _propTypes2.default.func.isRequired,
	FlightName: _propTypes2.default.string.isRequired,
	Origin: _propTypes2.default.string.isRequired,
	Destination: _propTypes2.default.string.isRequired,
	Departure: _propTypes2.default.string.isRequired,
	Arrival: _propTypes2.default.string.isRequired,
	searchQuery: _propTypes2.default.func.isRequired
};

exports.default = BookingListSection;
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						this.props.bookings.map(function (book) {
...
var _Flights = __webpack_require__(40);
...
var BookingListForm = function (_Component) {
	_inherits(BookingListForm, _Component);

	function BookingListForm() {
		_classCallCheck(this, BookingListForm);

		return _possibleConstructorReturn(this, (BookingListForm.__proto__ || Object.getPrototypeOf(BookingListForm)).apply(this, arguments));
	}

	_createClass(BookingListForm, [{
		key: 'onSubmit',
		value: function onSubmit(e) {
			e.preventDefault();
			var node = this.refs.query;
		...
		value: function render() {
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(_Flights2.default, this.props)
				),
				_react2.default.createElement(
					'div',
					{ className: 'input-field col s6' },
					_react2.default.createElement(
						...
						_react2.default.createElement('input', { ref: 'query', id: 'query', type: 'Search', className: 'validate', style: searchInputStyle }),
						_react2.default.createElement(
							'label',
							{ className: 'label-icon', htmlFor: 'query' },
							_react2.default.createElement(
								'i',
								{ className: 'material-icons', style: searchIconStyle },
								'search'
							)
						),
						_react2.default.createElement(
...
exports.default = BookingListForm;
...
var Flights = function (_Component) {
        _inherits(Flights, _Component);

        function Flights() {
                _classCallCheck(this, Flights);

                return _possibleConstructorReturn(this, (Flights.__proto__ || Object.getPrototypeOf(Flights)).apply(this, arguments));
        }

        _createClass(Flights, [{
                key: 'onChange',
                value: function onChange(e) {
                        var updateFlightList = this.props.updateFlightList;


                        var node = this.refs.fli;
                        var flightID = node.value;
                ...
                value: function render() {
                        ...
                        return _react2.default.createElement(
                                'select',
                                { id: 'rows', onChange: this.onChange.bind(this), ref: 'fli' },
                                _react2.default.createElement(
                                        'option',
                                        { disabled: true, defaultValue: true, value: '' },
                                        'Choose Flight'
                                ),
